...
const SideBar = ({sidebarToggle}) => {
  ...
  return (
    ...
    <nav className={sidebarToggle ? "sidenav" : "sidenav-collapse"} >
        <div className="px-3 py-3 brand-name d-flex aliogn-items-center">  
         <a href="/"><img src={LCI} className="w-23"/></a> 
          <h4 style={{fontSize:"18px"}} className={sidebarToggle ? "menu-item" : "menu-item-collapse"}>Lakshit&nbsp;Institute</h4>
      </div>
      <div className='user-login'>
        <h5 className='py-3 px-3'>
          <FaUserCircle style={{fontSize:"30px"}} />
          <span className={sidebarToggle ? "menu-item" : "menu-item-collapse"}>Admin&nbsp;User</span>
          </h5>
      </div>
        ...
        <ul className='px-2 my-3'>
          <li >
              <NavLink to="/"className='nav-item' activeclassname="active" >
                  ...
                  <span className={sidebarToggle? "menu-item" : "menu-item-collapse"}>Dashboard</span>
                </NavLink>
          </li>
          <li onClick={toggleClassroom} className='nav-dropdown' >
            <div  className='nav-item' >
                  ...
                  <span className={sidebarToggle ? "menu-item" : "menu-item-collapse"}>ClassRoom</span>
          ...
          <li onClick={toggleStudent} className='nav-dropdown'>
            <div  className='nav-item'>
                  ...
                  <span className={sidebarToggle ? "menu-item" : "menu-item-collapse"}>Student</span>
            </div>
          ...
          {studentOpen && (
              ...
              <li onClick={togglePayment} className='nav-dropdown'>
                <div className='nav-item'>
                      ...
                      <span className={sidebarToggle ? "menu-item" : "menu-item-collapse"}>Payment</span>
                </div>
                {paymentOpen ? (
                  <md.MdArrowDropUp />
                ) : (
                ...
                <ul>
                  ...
                  <li>
                      <NavLink to="/Fees"  className='sub-item'>
                        <FaRegCircle />
                        <span className={sidebarToggle ? "menu-item" : "menu-item-collapse"}>Fees</span>
                      </NavLink>
                  </li>
                 ...
                 <li>
                      ...
                      <NavLink to="/Hostel" className='sub-item' >
                         <FaRegCircle />
                          <span className={sidebarToggle ? "menu-item" : "menu-item-collapse"}> Hostel</span>
                      </NavLink>
                  </li>
                </ul>
              )}
